%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bounce_partial_mirror.m
% 
% Helper function for computing ray bounces from partial mirror objects 
% (built-in). These objects spawn one child ray that represents transmission,
% while reflecting the parent object as with a normal mirror.
% 
...
% Patrick Kilcullen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [normal, ch_normal, data_out, cont] = bounce_partial_mirror( ...
    bounce_info, data_in)
    ...
    normal = old_norm - 2*dot(old_norm, surf_norm)*surf_norm;   % Reflected ray
    ch_normal = old_norm;   % Transmitted ray
    data_out = data_in;
    cont = true;
end
